...
ChristoffelSymbol1st::usage="ChristoffelSymbol1st[g,x], with g a nxn-matrix
...
ChristoffelSymbol2nd::usage="ChristoffelSymbol2nd[g,x], with g a nxn-matrix
...
NormalVector::usage="NormalVector[g,x,i,sV] with g a nxn-matrix
...
d\[Times]d matrix gives a (d+1)\[Times](d+1) metric."
